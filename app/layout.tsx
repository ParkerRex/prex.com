...
export const metadata: Metadata = {
  ...
  description: 'AI-first builder & content creator. Building tools, teaching workflows, scaling businesses. Product manager turned entrepreneur focused on AI development and education.',
  keywords: ['Parker Rex', 'AI development', 'product management', 'software engineering', 'content creator', 'entrepreneur', 'startup', 'technology', 'AI tools', 'automation'],
  ...
  openGraph: {
    ...
    description: 'AI-first builder & content creator. Building tools, teaching workflows, scaling businesses.',
    siteName: 'Parker Rex',
    images: [
      {
        url: '/og-image.png',
