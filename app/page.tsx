      ...
      <div className="container mx-auto px-4 py-16 max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            tldr: ai-first builder & content creator. building tools, teaching workflows, scaling businesses. usually
        ...
        {/* Stats */}
        <div className="mb-12">
          <h2 className="text-gray-500 text-xs uppercase tracking-wider mb-6 text-center">stats</h2>
          <div className="space-y-4">
            ...
            <div className="bg-gray-900 p-4 rounded-lg">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <div className="text-gray-400 text-sm">11 / 20 miles completed</div>
                </div>
              </div>
            ...
            <div className="bg-gray-900 p-4 rounded-lg flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-gray-400 text-sm">last commit 15 minutes ago</div>
              </div>
            ...
            <div className="bg-gray-900 p-4 rounded-lg flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-gray-400 text-sm">last commit 2 hours ago</div>
              </div>
              <div className="flex items-center gap-1 text-gray-400 text-sm">
                <Star className="w-3 h-3" />
                <span>89</span>
            ...
            <div className="bg-gray-900 p-4 rounded-lg flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-gray-400 text-sm">last commit 1 day ago</div>
              </div>
              <div className="flex items-center gap-1 text-gray-400 text-sm">
                <Star className="w-3 h-3" />
                <span>234</span>
        ...
        {/* Socials */}
        <div className="mb-12">
          <h2 className="text-gray-500 text-xs uppercase tracking-wider mb-6 text-center">socials</h2>
          <div className="space-y-4">
            <a
            ...
            >
              ...
              <div>
                ...
                <div className="text-gray-400 text-sm">this is where i'm most active</div>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <div className="text-gray-400 text-sm">monday, wednesday, friday - ai tools that actually work</div>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <div className="text-gray-400 text-sm">building in public every single day</div>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <div className="text-gray-400 text-sm">i'm really not professional enough to be on here</div>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <div className="text-gray-400 text-sm">where i build in public and share code</div>
              </div>
            </a>
          </div>
        </div>
        ...
        {/* Projects */}
        <div>
          <h2 className="text-gray-500 text-xs uppercase tracking-wider mb-6 text-center">projects</h2>
          <div className="space-y-4">
            <a
            ...
            >
              ...
              <div>
                ...
                <div className="text-gray-400 text-sm">
                  private builder network with custom dev tools, active discord, and weekly drops
                </div>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <div className="text-gray-400 text-sm">ai-first agency helping businesses onboard to the ai world</div>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <div className="text-gray-400 text-sm">content & sponsorship partnerships with brands</div>
              </div>
            </Link>
            ...
            >
              ...
              <div>
                ...
                <div className="text-gray-400 text-sm">done-for-you automation & ai mvp development</div>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <div className="text-gray-400 text-sm">ai roadmaps & fractional cpo services</div>
              </div>
            </a>
          </div>
        </div>
