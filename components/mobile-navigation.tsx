...
const primaryNavItems: NavItem[] = [
	...
	{ route: "/content", label: "Content", icon: VideoIcon, shortLabel: "Content" },
	{ route: "/research", label: "Research", icon: MagnifyingGlassIcon, shortLabel: "Research" },
];

const moreNavItems: NavItem[] = [
	{ route: "/about", label: "About", icon: PersonIcon, shortLabel: "About" },
	{ route: "/bio", label: "Bio", icon: PersonIcon, shortLabel: "Bio" },
	{ route: "/blog", label: "Blog", icon: ReaderIcon, shortLabel: "Blog" },
	{ route: "/whiteboards", label: "Whiteboards", icon: DrawingPinFilledIcon, shortLabel: "Whiteboards" },
	{ route: "/sponsors", label: "Sponsors", icon: BackpackIcon, shortLabel: "Sponsors" },
];
						...
						<DropdownMenuTrigger asChild>
							<button
								className={cn(
									...
									moreNavItems.some(item => pathname === item.route) && "bg-gray-100 dark:bg-gray-900"
								)}
							>
								...
								<div className={cn(
									"relative transition-transform duration-200",
									moreNavItems.some(item => pathname === item.route) && "scale-110"
								)}>
									<DotsHorizontalIcon className={cn(
										"w-5 h-5 transition-colors duration-200",
										moreNavItems.some(item => pathname === item.route)
											? "text-black dark:text-white" 
											: "text-gray-600 dark:text-gray-400"
									...
									<DropdownMenuItem key={item.route} asChild>
										<Link
											...
											className={cn(
												...
												isActive && "bg-gray-100 dark:bg-gray-900 font-semibold"
											)}
										>
											<Icon className={cn(
												"w-4 h-4",
