	...
	return (
		<div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
			{metrics.map((metric, index) => (
				<Card
					key={index}
					className="p-6 text-center bg-gray-50 dark:bg-gray-900 border-gray-300 dark:border-gray-700"
				>
				...
				<table className="w-full text-sm">
					<thead>
						<tr className="border-b border-gray-300 dark:border-gray-700">
							<th className="text-left py-3 px-4 font-normal uppercase tracking-widest text-xs">
								Metric
							</th>
							<th className="text-left py-3 px-4 font-normal uppercase tracking-widest text-xs">
								Pre-Optimization
