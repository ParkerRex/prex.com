...
async function searchChannelVideos(channelHandle: string, maxResults = 10): Promise<YouTubeVideo[]> {
...
export async function getChannelVideos(channel: 'parkerrex' | 'parkerrexdaily', maxResults = 10): Promise<ProcessedVideo[]> {
	try {
